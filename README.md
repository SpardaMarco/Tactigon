...
During the game, the move input is validated using the **ask_move/2** predicate, which asks the user for two pairs of coordinates and reads the input. Each pair of coordinates is validated using ... 
```prolog
